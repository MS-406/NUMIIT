                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        (scan.notes != null && scan.notes!.isNotEmpty) 
                            ? scan.notes! 
                            : 'Coin ${coinNumber ?? scan.id ?? scan.scannedAt.millisecondsSinceEpoch.toString().substring(8)}',
                        style: AppTypography.body(15, weight: FontWeight.w600),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                      ),
                      if (region?.transliteration != null && region!.transliteration.isNotEmpty)
                        Text(
                          region.transliteration,
                          style: AppTypography.body(13, color: AppColors.textSecondary, weight: FontWeight.w500),
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                        ),
                      Text(
